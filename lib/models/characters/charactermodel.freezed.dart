...
class _$CharacterModelImpl implements _CharacterModel {
  _$CharacterModelImpl({this.id, this.name, this.image, this.status});
  ...
  @override
  String toString() {
    return 'CharacterModel(id: $id, name: $name, image: $image, status: $status)';
  }
...
abstract class _CharacterModel implements CharacterModel {
  factory _CharacterModel(
      ...
      final String? name,
      final String? image,
      final String? status}) = _$CharacterModelImpl;
